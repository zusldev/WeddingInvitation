...
.week6 {
  margin-right: 31rem; /* Ajusta el margen según tus preferencias */
}
...
.num14 {
  background: none; /* Quita el fondo rosa */
  color: black;
  font-size: 1.5rem; /* Tamaño más grande para el número 14 (ajusta según tu preferencia) */
  display: flex;
  align-items: center;
  justify-content: center;
...
.num14::before {
  content: '♥'; /* Inserta el carácter de corazón */
  position: absolute;
  top: -1.2rem;
  left: -0.7rem;
  font-size: 3.4rem; /* Ajusta el tamaño del corazón según tus preferencias */
  color: #B4D2ACFF;
  z-index: -1; /* Coloca el corazón detrás del número 14 */
}
...
@media (max-width: 420px) {
  .week6 {
    margin-right: 16rem; /* Ajusta el margen según tus preferencias */
  }
}
</style>
