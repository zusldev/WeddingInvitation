...
.button {
  border-radius: 50%;
  width: 67px; /* Tamaño del botón para pantallas grandes */
  height: 67px; /* Tamaño del botón para pantallas grandes */
  display: flex;
...
.button img {
  width: 70px; /* Tamaño del icono para pantallas grandes */
  height: 70px; /* Tamaño del icono para pantallas grandes */
}
